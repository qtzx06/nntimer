...
def train():
    ...
    print(f"important: class to index mapping: {full_dataset.class_to_idx}") # <-- added this line
    ...
    for epoch in range(EPOCHS):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in progress_bar:
                ...
                progress_bar.set_postfix(loss=running_loss / (progress_bar.n + 1), acc=running_corrects.double() / (progress_bar.n + 1) / BATCH_SIZE)
